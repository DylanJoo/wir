...
input3 = tokenizer('yes yes yes', return_tensors='pt')
...
output = model(**tokenizer('hello world', return_tensors='pt'),
    sub_input_ids=input2['input_ids'],
    sub_attention_mask=input2['attention_mask'],
    sub_token_type_ids=input2['token_type_ids']
)
